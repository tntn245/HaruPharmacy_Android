...
public class UserEditAddressActivity extends AppCompatActivity {
    private EditText edit_address_txt_name, edit_address_txt_phone, edit_address_txt_address_detail;
    private Button btn_save_edit_address, btn_cancel_edit_address, btn_delete_address;
    private Spinner edit_address_spn_province, edit_address_spn_district, edit_address_spn_commune;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_address_spn_province = findViewById(R.id.edit_address_spn_province);
        edit_address_spn_district = findViewById(R.id.edit_address_spn_district);
        edit_address_txt_address_detail = findViewById(R.id.edit_address_txt_address_detail);
        btn_save_edit_address = findViewById(R.id.btn_save_edit_address);
        btn_cancel_edit_address = findViewById(R.id.btn_cancel_edit_address);
        btn_delete_address = findViewById(R.id.btn_delete_address);
        edit_address_txt_name = findViewById(R.id.edit_address_txt_name);
        edit_address_txt_phone = findViewById(R.id.edit_address_txt_phone);
        ...
        edit_address_spn_province.setAdapter(provinceAdapter);
        ...
        setTextForSelectedItem();
        edit_address_spn_province.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selectedProvince = edit_address_spn_province.getSelectedItem().toString();
                {
                    ...
                    edit_address_spn_district.setAdapter(districtAdapter);
                }
            }
        ...
        edit_address_spn_district.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                edit_address_spn_commune = findViewById(R.id.edit_address_spn_commune);
                selectedDistrict = edit_address_spn_district.getSelectedItem().toString();
                ...
                edit_address_spn_commune.setAdapter(communeAdapter);
            }
        ...
        btn_save_edit_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String name = edit_address_txt_name.getText().toString();
                String phone = edit_address_txt_phone.getText().toString();
                String province = edit_address_spn_province.getSelectedItem().toString();
                String district = edit_address_spn_district.getSelectedItem().toString();
                String commune = edit_address_spn_commune.getSelectedItem().toString();
                String detail_address = edit_address_txt_address_detail.getText().toString();
                if (province.equals("Chọn tỉnh thành phố")) {
                    Toast.makeText(UserEditAddressActivity.this, "Vui lòng chọn tỉnh thành phố", Toast.LENGTH_SHORT).show();
                } else {
                    if (district.equals("Chọn quận huyện"))
                        Toast.makeText(UserEditAddressActivity.this, "Vui lòng chọn quận huyện", Toast.LENGTH_SHORT).show();
                    else {
                        if (commune.equals("Chọn phường xã"))
                            Toast.makeText(UserEditAddressActivity.this, "Vui lòng chọn phường xã", Toast.LENGTH_SHORT).show();
                        else {
        ...
        btn_delete_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(UserEditAddressActivity.this);
                builder.setTitle("Xóa địa chỉ");
                builder.setMessage("Bạn có chắc chắn muốn xóa địa chỉ?");
                builder.setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (getIntent().getExtras().getString("previousActivity").equals("UserAddressesActivity")) {
                            String idAddressSelected = getIntent().getExtras().getString("addressIdSelected");
                            deleteAddressFromFirebase(idAddressSelected);
                            Intent intent = new Intent(UserEditAddressActivity.this, UserAddressesActivity.class);
                            startActivity(intent);
                            finish();
                        }
        ...
        btn_cancel_edit_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getIntent().getExtras().getString("previousActivity").equals("UserAddressesActivity")) {
                    Intent intent = new Intent(UserEditAddressActivity.this, UserAddressesActivity.class);
    ...
    private void setTextForSelectedItem() {
        String receiverName, phone, province, district, commune, address_detail;
        ...
        address_detail = getIntent().getExtras().getString("addr_detail");
        edit_address_txt_name.setText(receiverName);
        edit_address_txt_phone.setText(phone);
        int provinceSpinnerPosition = provinceAdapter.getPosition(province);
        edit_address_spn_province.setSelection(provinceSpinnerPosition);
        edit_address_txt_address_detail.setText(address_detail);
    }

    private void savedEditAddress() {
        ...
        if (firebaseUser != null) {
            ...
            String commune = edit_address_spn_commune.getSelectedItem().toString();
            String detail_address = edit_address_txt_address_detail.getText().toString();
            String id_address = getIntent().getExtras().getString("addressIdSelected");
            DatabaseReference newAddressRef = addressRef.child(id_address);
            ShipmentInf newShipmentInf = new ShipmentInf(id_address, userId, name, phone, province, district, commune, detail_address);
            newAddressRef.setValue(newShipmentInf);
        }
    }
    ...
    private void deleteAddressFromFirebase(String addressId) {
        ...
        addressToDeleteRef.removeValue(new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                if (error == null) {
                    // Xóa thành công
                    Toast.makeText(UserEditAddressActivity.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                } else {
                    // Xóa thất bại
                    Toast.makeText(UserEditAddressActivity.this, "Xóa thất bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
